...
import * as sty from "./PlasmicValueprop.module.css" // plasmic-import: GySzFoyQdAzs/css
...
function PlasmicValueprop__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__xPvct, {
          [sty.freeBox__card__xPvctNq2UG]: hasVariant(variants, "card", "card"),
          [sty.freeBox__card_vertical__xPvctNq2UGTXiPp]:
            hasVariant(variants, "card", "card") &&
            hasVariant(variants, "vertical", "vertical"),
          [sty.freeBox__color_lightQuarternary__xPvctyCYm1]: hasVariant(
            variants,
            "color",
            "lightQuarternary"
          ),
          [sty.freeBox__flatIcon__xPvctDBY]: hasVariant(
            variants,
            "flatIcon",
            "flatIcon"
          ),
          [sty.freeBox__flat__xPvctRgTv]: hasVariant(variants, "flat", "flat"),
          [sty.freeBox__vertical__xPvcttXiPp]: hasVariant(
            variants,
            "vertical",
            "vertical"
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__vun9F)}
              role={"img"}
              src={
      ...
      {false ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__zIupA, {
            [sty.freeBox__card__zIupANq2UG]: hasVariant(
              variants,
              "card",
              "card"
            ),
            [sty.freeBox__card_vertical__zIupANq2UGTXiPp]:
              hasVariant(variants, "card", "card") &&
              hasVariant(variants, "vertical", "vertical"),
            [sty.freeBox__color_lightQuarternary__zIupAyCYm1]: hasVariant(
              variants,
              "color",
              "lightQuarternary"
            ),
            [sty.freeBox__flatIcon__zIupAdBY]: hasVariant(
              variants,
              "flatIcon",
              "flatIcon"
            ),
            [sty.freeBox__flat__zIupArgTv]: hasVariant(
              variants,
              "flat",
              "flat"
            ),
            [sty.freeBox__vertical__zIupAtXiPp]: hasVariant(
              variants,
              "vertical",
              "vertical"
            ),
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon8Icon
                className={classNames(defaultcss.all, sty.svg__sm1At)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__l2OLk, {
          [sty.freeBox__flat__l2OLkRgTv]: hasVariant(variants, "flat", "flat"),
          [sty.freeBox__justDescription__l2OLk4F6He]: hasVariant(
            variants,
            "justDescription",
            "justDescription"
          ),

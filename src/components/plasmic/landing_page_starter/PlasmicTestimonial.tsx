...
import * as sty from "./PlasmicTestimonial.module.css" // plasmic-import: e8KAeH5FeOY2/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__n1AHa)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__zovFl)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__pjNmh)}
              role={"img"}
            />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__gmOwv)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__xciHa)}>
            {p.renderPlasmicSlot({

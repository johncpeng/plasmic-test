...
import * as sty from "./PlasmicLogo.module.css" // plasmic-import: LK_Qw8YOQ8Z6/css
...
export const PlasmicLogo__VariantProps = new Array<VariantPropType>("_50Opaque")

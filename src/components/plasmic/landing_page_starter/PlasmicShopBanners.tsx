...
import * as sty from "./PlasmicShopBanners.module.css" // plasmic-import: sts-1aMl9nV4/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <Banner
              className={classNames("__wab_instance", sty.banner__ptCbt)}
            />

            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__uu4GR)}
            >
              <Banner
                className={classNames("__wab_instance", sty.banner__e9KnX)}
              >
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img___93UaM)}
                  role={"img"}
                  src={
              ...
              <Banner
                className={classNames("__wab_instance", sty.banner___1JsWy)}
              >
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__ig4N)}
                  role={"img"}
                  src={

...
import * as sty from "./PlasmicTestimonialsSection1.module.css" // plasmic-import: yR8TzXWPSzef/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__itfzz)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__g2KeY)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames(
                  "__wab_instance",
                  sty.testimonial___5WoxM
                )}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__s3DlT)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__hOVgd)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__tQyCf)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__hvjnv)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__k8W01)}
                    role={"img"}
                    src={

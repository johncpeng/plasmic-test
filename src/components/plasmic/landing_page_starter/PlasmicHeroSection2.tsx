...
import * as sty from "./PlasmicHeroSection2.module.css" // plasmic-import: wvyhiNs9CyEw/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Navigation
              className={classNames("__wab_instance", sty.navigation___2Svip)}
              hideCta={"hideCta" as const}
            >
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__zSz92)}
                role={"img"}
            ...
            defaultContents: (
              <React.Fragment>
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__vBsR)}
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__xQVd)}
                  >
                    <div
                      className={classNames(defaultcss.all, sty.freeBox__ng0Gg)}
                    >
                      <div
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__eEfa)}
                  >
                    <Button
                      className={classNames(
                        "__wab_instance",
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__tcbKz)}
                >
                  <div
                    className={classNames(defaultcss.all, sty.freeBox__qQmKu)}
                  >
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(defaultcss.all, sty.freeBox___0GqU)}
                    >
                      <div
                        className={classNames(
                          defaultcss.all,
                    ...
                    <div
                      className={classNames(defaultcss.all, sty.freeBox__t1Mav)}
                    >
                      <div
                        className={classNames(
                          defaultcss.all,

...
import * as sty from "./PlasmicButton.module.css" // plasmic-import: YCIrrtDRaysK/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__ruzO)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg___8VeCf)}
                role={"img"}
              />
            ),

...
import Logo from "../../Logo" // plasmic-import: LK_Qw8YOQ8Z6/component
...
import * as sty from "./PlasmicNavigation.module.css" // plasmic-import: qNYDr4Pn-StM/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__eiCj4, {
          [sty.freeBox__centered__eiCj4C3Hz5]: hasVariant(
            variants,
            "centered",
            "centered"
          ),
          [sty.freeBox__dark__eiCj4RFtbI]: hasVariant(variants, "dark", "dark"),
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Logo className={classNames("__wab_instance", sty.logo__aLbjz)} />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__l6Wj0, {
            [sty.freeBox__centered__l6Wj0C3Hz5]: hasVariant(
              variants,
              "centered",
              "centered"
            ),
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <Button
                  className={classNames("__wab_instance", sty.button__hTy0N)}
                  navLink={"navLink" as const}
                  slot={"Services"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__ro8Bw)}
                  navLink={"navLink" as const}
                  slot={"Features"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__gtWjV)}
                  navLink={"navLink" as const}
                  slot={"Company"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__ufxO)}
                  navLink={"navLink" as const}
                  slot={"Contact"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__cqi3Q)}
                  navLink={"navLink" as const}
                  slot={"Log in"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__m8W4O)}
        ...
        {(hasVariant(variants, "centered", "centered") ? true : false) ? (
          <div
            className={classNames(defaultcss.all, sty.freeBox__ivVi, {
              [sty.freeBox__centered__ivViC3Hz5]: hasVariant(
                variants,
                "centered",
                "centered"
              ),
          ...
          >
            {(hasVariant(variants, "centered", "centered") ? false : true) ? (
              <button
                className={classNames(
                  ...
                  sty.button__ilEBv,
                  {
                    [sty.button__centered__ilEBvC3Hz5]: hasVariant(
                      variants,
                      "centered",
                      "centered"
                    ),
                    [sty.button__dark__ilEBvRFtbI]: hasVariant(
                      variants,
                      "dark",
                      "dark"
                    ),
            ...
            <Button
              className={classNames("__wab_instance", sty.button__vm7Jz, {
                [sty.button__dark__vm7JzrFtbI]: hasVariant(
                  variants,
                  "dark",
                  "dark"
                ),

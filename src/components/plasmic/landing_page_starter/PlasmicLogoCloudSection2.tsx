...
import * as sty from "./PlasmicLogoCloudSection2.module.css" // plasmic-import: _ORstzIZCC8p/css
        ...
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__kjk40)}
                role={"img"}
                src={loomsvg25DMlo9FInfLm}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__pur2)}
                role={"img"}
                src={strapisvg2DDfrhn4WbDo}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img___02Agl)}
                role={"img"}
                src={segmentsvg2Fk1GcYHyOo3M}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__sqNxD)}
                role={"img"}
                src={xstate1SvgBOlqe3G8V20L}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__igPNk)}
                role={"img"}
                src={mapboxsvg201RdjOGpXIh1}
              />
            </React.Fragment>
          ),
          value: args.children,
